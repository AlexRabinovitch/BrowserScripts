...
function fillFilters()
{
    ...
    var marxExcludedTerms = ['fortune', 'sleeping beauty', '\\bnot? Marx\\b', 'Marx-U', 'marx style', 'Marx.?\\?', 'marx( toys)? \\(\\?\\)', 'good with marx', 'replicants', 'MPC', 'tim.?mee', 'Linemar', 'Karl Marx', 'Marx, Karl', 'Engels', 'Spencer', 'Barzso', 'Schaffner', 'Richard Marx', 'Marx brothers', 'Maddox', 'Garret', 'rides again', 'Marx similar', 'Herbert', 'Thunderbolt', 'jean h(oe|ö)fler', '10\'\'', '9"', '12"'];
