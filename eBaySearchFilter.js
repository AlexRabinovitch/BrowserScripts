...
//    filter.excludeItemIDs = [154246251005];
    ...
    filter.excludeTerms = ['Atlantic Scheme', 'Boeing', 'bombardier', 'carabinieri', 'paratroop', 'air force', 'bersaglieri', 'vespa', 'jeep', 'battalion', 'rocket', 'missile', 'cannon', 'frog', 'truck', 'marine', 'patrol', 'troop', 'sailor', 'lenin', 'fusilier', 'modern', 'decal', '\\bair\\b', '\\bcar(s)?\\b', '\\b1(0|1|5)\\d{2}\\b', '\\b11\\d{3}\\b'];
    _filters[filter.searchName] = filter;
