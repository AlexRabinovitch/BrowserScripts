...
function fillFilters()
{
    ...
    var marxExcludedTerms = ['fortune', 'sleeping beauty', '\\bnot? Marx\\b', 'Marx-U', 'marx style', 'Marx.?\\?', 'marx( toys)? \\(\\?\\)', 'good with marx', 'replicants', 'MPC', 'tim.?mee', 'Linemar', 'Karl Marx', 'Marx, Karl', 'Engels', 'Spencer', 'Barzso', 'Schaffner', 'Richard Marx', 'Marx brothers', 'Maddox', 'Garret', 'rides again', '10\'\'', '9"', '12"'];
    ...
    var excludeTermsElastolin = ['\\bgerman(s)?\\b', 'Prussian', 'wehrmacht', 'Luftwaffe', 'Preu(ß|ss)', 'soldat allemand', 'ähnlich Elastolin', 'auch zu Elastolin', 'elastolin compatible', 'elastolin\\?', '(suitable|matching|fits|compatible) (for|to|type|wie|with) Elastolin', '\\bno Elastolin', 'w\\/Elastolin', 'not elastolin', 'non elastolin', '^elastolin$', 'bundeswehr', 'Musikkorps'];
