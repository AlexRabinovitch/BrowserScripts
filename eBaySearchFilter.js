...
function fillFilters()
{
    ...
    var inch456Exclude = ['crescent', 'payton', 'duck', 'bend', 'Squishmallow', 'drum', '\\bpee', '(doctor|dr) who', 'rescue', 'dime novel', 'taxi', 'leather', 'lanard', 'Space Jam', '\\bnba\\b', 'bandai', 'motorhead', 'Squeaker', 'zombie', 'Julius Jones', 'burger king', 'plastoy', 'pickles', '\\barco\\b', 'grandex', 'vampire', 'Geronimo', '\\bDC\\b', '#5', '1 1/4"', '1.5"', '1 3/4"', '2 1/4', '2.5”', '2.5 inch', '2.5"', '2 3/4"', '2-1/4', '2 1/4"', '2.5”', '2-3/4"', '2 3/4', '2.75"', '1:12', '1/12', '8 3/4"', '12.5"'];
    ...
    filter.excludeTerms = ['Chap Mei', 'Pail', 'Sesame', 'giraffe', 'clicker', 'donald', 'baby', 'boot', 'subway', 'disney', 'GI Joe', 'my little pony', 'menko', 'cowboy hat', 'Logan', 'Orton', 'Chip Mei', 'Totsy', 'rocking', 'slug', 'NFL', 'Owens', 'chess', 'Posable', 'elephant', 'blanket', 'pocahontas', 'Wolverine', 'McFarlane', 'Skyforce', 'troll'];
...
//    filter.excludeItemIDs = [154246251005];
    ...
    filter.excludeTerms = ['\\b4\\d{4}','10\\d{3}', '\\b5(6|7|8)\\d{3}', '\\b523\\d{2}', '\\b541\\d{2}', '\\b(\\d{1})?30\\d{2}\\b', '\\b5(3|4)\\d{2}\\b', '\\b5475\\d{1}\\b', '\\bGerman\\b', 'Wehrmacht', 'Luftwaffe', 'Prussian', 'bburago', '^Starlux', 'Feuerwehrmänner', 'les animaux', 'le monde civil', 'creche *de *noel', 'civil world', 'modern army', 'musiker', 'soldat allemand', 'Preuß', 'infanterie', 'regiment', '45mm'];
    _filters[filter.searchName] = filter;
