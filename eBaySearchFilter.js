...
{
    return processNonTitleItems(filter.excludeSellers, node, 'span.s-item__seller-info', 'Seller');
}
...
function fillFilters()
{
    ...
    var inch456Exclude = ['crescent', 'payton', 'duck', 'bend', 'Squishmallow', 'drum', '\\bpee', '(doctor|dr) who', 'rescue', 'dime novel', 'taxi', 'leather', 'lanard', '\\bnba\\b', 'bandai', 'motorhead', 'Squeaker', 'zombie', 'Julius Jones', 'plastoy', 'pickles', '\\barco\\b', 'grandex', 'vampire', 'Geronimo', '\\bDC\\b', 'mirror', 'bebo(b|p)', 'space', '\\bryan.*world', 'noodle', 'steel', '1 1/4"', '1.5"', '1.5”', '1 3/4"', '2 1/4', '2.5”', '2.5 inch', '2.5"', '2 3/4"', '2-1/4', '2 1/4"', '2.5”', '2-3/4"', '2 3/4', '2.75"', '1:12', '1/12', '8 3/4"', '12.5"', '1/144'];
...
//    filter.excludeItemIDs = [154246251005];
    ...
    filter.excludeTerms = ['\\b4\\d{4}','10\\d{3}', '\\b5(6|7|8)\\d{3}', '\\b523\\d{2}', '\\b541\\d{2}', '\\b(\\d{1})?30\\d{2}\\b', '\\b5(3|4)\\d{2}\\b', '\\b5475\\d{1}\\b', '\\b73(5|6|8)\\d{1}\\b', '\\b780\\d{1}\\b', '\\b3(7|8|9)\\d{2}\\b', '\\b5(7|8|9)\\d{2}\\b', '\\b67\\d{2}\\b', '\\bGerman\\b', 'Wehrmacht', 'Luftwaffe', 'Prussian', 'bburago', '^Starlux', 'Feuerwehrmänner', 'les animaux', 'le monde civil', 'creche *de *noel', 'civil world', 'modern army', 'musiker', 'Musikkapelle', 'soldat allemand', 'Preu(ß|ss)', 'infanterie', 'regiment', 'tedesco', 'Deutscher', 'Master Box', 'ähnlich Elastolin', 'auch zu Elastolin', '45mm'];
    _filters[filter.searchName] = filter;
